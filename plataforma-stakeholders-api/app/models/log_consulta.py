...
class LogConsulta(BaseModel):
    ...
    consulta_id = db.Column(db.Integer, db.ForeignKey(Consulta.consulta_id), nullable=False)
    tipo_log_id = db.Column(db.Integer, db.ForeignKey(TipoLog.tipo_log_id), nullable=False)
