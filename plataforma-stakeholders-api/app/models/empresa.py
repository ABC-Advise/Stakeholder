...
class Empresa(BaseModel):
    ...
    porte_id = db.Column(db.SmallInteger, db.ForeignKey('plataforma_stakeholders.porte_empresa.porte_id'), nullable=False)
    segmento_id = db.Column(db.SmallInteger, db.ForeignKey('plataforma_stakeholders.segmento_empresa.segmento_id'), nullable=False)
